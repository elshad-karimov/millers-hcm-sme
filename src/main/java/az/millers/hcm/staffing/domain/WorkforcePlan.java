...
@Entity
@Table(name = "workforce_plan", schema = "staffing")
@Getter
@Setter
@NoArgsConstructor
public class WorkforcePlan {
    ...
    private ScenarioType scenarioType = ScenarioType.BASELINE;
    ...
    private WorkforcePlanStatus status = WorkforcePlanStatus.DRAFT;
    ...
    void onCreate() {
        ...
        createdAt = now;
        updatedAt = now;
        if (status == null) status = WorkforcePlanStatus.DRAFT;
        if (scenarioType == null) scenarioType = ScenarioType.BASELINE;
    }
