...
public class EmployeeIdentificationService {
    ...
    /**
     * PII gate: roles that already see {@code Employee.nationalId} in plain
     * (SYSTEM_ADMIN / HR_ADMIN / AUDITOR) also see plaintext identification
     * document numbers. Everyone else gets the {@code "…1234"} mask.
     */
