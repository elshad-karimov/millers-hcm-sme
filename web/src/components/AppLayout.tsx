...
const NAV_MAP: Array<{ prefix: string; module: string; screen: string }> = [
  ...
  { prefix: '/budgets/settings', module: 'budgeting', screen: 'budgets-settings' },
  { prefix: '/budgets/variance', module: 'budgeting', screen: 'budgets-variance' },
  { prefix: '/budgets/forecast', module: 'budgeting', screen: 'budgets-forecast' },
  ...
  { prefix: '/learning/skill-inventory', module: 'learning', screen: 'learning-skill-inventory' },
      ...
      ? [
          {
            ...
            children: [
              ...
              {
                key: 'budgets-forecast',
                icon: <BarChartOutlined />,
                label: <Link to="/budgets/forecast">Payroll Forecast</Link>,
              },
              {
                key: 'budgets-variance',
                icon: <FundOutlined />,
                label: <Link to="/budgets/variance">Variance</Link>,
              },
              {
                key: 'budgets-settings',
                icon: <SettingOutlined />,
                label: <Link to="/budgets/settings">Settings</Link>,
              },
            ],
          } satisfies ItemType,
        ]
      ...
      ? [
          {
            ...
            children: [
              ...
              {
                key: 'learning-skill-inventory',
                icon: <BarChartOutlined />,
                label: <Link to="/learning/skill-inventory">Skill inventory</Link>,
              },
              {
