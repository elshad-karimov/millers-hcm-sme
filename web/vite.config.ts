...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      // https://localhost:8543. Browsers (especially Firefox, which has
      ...
      '/realms':    { target: 'https://localhost:8543', secure: false, changeOrigin: true },
      '/resources': { target: 'https://localhost:8543', secure: false, changeOrigin: true },
      '/js':        { target: 'https://localhost:8543', secure: false, changeOrigin: true },
    },
  },
})
